...
def example_euler(n):
    ...
    print(
        "\nResult of",
        n,
        "iterations FORWARD method to estimate f(12) =",
        resultf[0][n - 1],
    )
    print(
        "Result of",
        n,
        "iterations BACKWARD method to estimate f(12) =",
        resultb[0][n - 1],
    )
    ...
    print(
        ...
        round(((abs(23.6875 - resultf[0][n - 1]) / 23.6875) * 100), 5),
        "%",
    )
    print(
        "BACKWARD Relative error:",
        round(((abs(23.6875 - resultb[0][n - 1]) / 23.6875) * 100), 5),
        "%\n",
    )
